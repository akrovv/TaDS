...
void print_task(void)
{
    printf("%s",
           ...
           "Программа при помощи стека вычисляет арифметическое выражение типа: число|знак| ... число|знак| число.\n"
           "Правила ввода строки : \n"
           "1. Вводить символы без пробелов и нажать Enter(перевод на следующую строку)\n"
           "2. Диапозон вводимых чисел 0-9.\n"
           "3. Знаки только +-.\n"
           "Максимальный размер стека - 1000 * sizeof(char).\n");
}
